...
class SeguimientoController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        return view('Seguimiento.seguimiento', compact('count_notification','tipo', 'tipo_alert', 'array_color'));
    }
    ...
    public function finalizadas()
    {
        ...
        $array_color = (new Colores)->getColores();
        return view('Seguimiento.seguimiento_finalizadas', compact('count_notification','comuna','direcciones','sexo', 'tipo_alert', 'array_color'));
    }
    ...
    public function finalizadas2()
    {
        ...
        return view('Seguimiento.seguimiento_finalizadas2', compact('count_notification','comuna','direcciones','sexo', 'tipo_alert', 'array_color'));
    }
    ...
    public function getSeguimiento(Request $request)
    {
        try {            
            $tipo = $request->tipo;
            if ($request->ajax()) {
                $data = (new Solicitud)->getSolicitudList_DataTable2($tipo);
    ...
    public function getSeguimientoFinalizadas(Request $request)
    {
        try {            
            if ($request->ajax()) { 
                $data = (new Seguimiento)->getSolicitudList_Finalizadas($request->fecha_desde, $request->fecha_hasta,$request->comuna, $request->direcciones, $request->sexo);
...

    {
        try {            
            if ($request->ajax()) { 
                $data = (new Seguimiento)->getSolicitudList_Finalizadas2($request->fecha_desde, $request->fecha_hasta,$request->comuna, $request->direcciones, $request->sexo);
