        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    {!! Form::select('comuna', [NULL => 'Seleccionar', '0' => 'FORANEO'] + $comuna, NULL, ['class' => 'form-control', 'id' => 'comuna']) !!}    
                </div>
                <div class="col-md-2">
...
<script type="text/javascript">
    $(function () {
        $('#btn_listado').click(function() {
            ...
            var url = "{{ route('imprimir2') }}" + "?fecha_desde=" + fechaDesde + "&fecha_hasta=" + fechaHasta + "&comuna=" + comuna + "&direcciones=" + direccion + "&sexo=" + sexo;
