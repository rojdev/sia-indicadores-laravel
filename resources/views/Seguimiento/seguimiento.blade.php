...
<div>
    @if($tipo == 1)
    <h2 style="margin-bottom: -50px"><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px" >Solicitudes de Denuncias, Quejas, Reclamos</h2>
    @elseif($tipo == 2)
    <h2 style="margin-bottom: -50px"><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px" >Solicitudes de Asesorias, Sugerencias</h2>
    @endif
</div>
@endsection
