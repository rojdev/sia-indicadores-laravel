            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <div class="form-group">
                    <div style="text-align:left;">
                        ...
                        {!! Form::text('solicitud_salud_id_show', old('solicitud_salud_id'), ['placeholder' => isset($correlativoSALUD) ? $correlativoSALUD : $correlativoATC, 'class' => 'form-control', 'id' => 'solicitud_salud_id', 'DISABLED' => TRUE]) !!}
                    ...
                    <div style="text-align:left;">
                        ...
                        <div style="text-align:left;">
                            ...
                            <select name="tipo_solicitud_id" id="tipo_solicitud_id" class="form-control" disabled>
                        ...
                        if($solicitud_edit->tipo_solicitud_id == 3){
                            ...
                            <div style="text-align:left;">
                                {!! Form::label('presentada', 'DENUNCIA PRESENTADA*', ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>
                                {!! Form::select('presentada', $opcionesPresentada, $solicitud_edit->denuncia->presentada ?? null, ['class' => 'form-control', 'id' => 'presentada', 'disabled' => true]) !!}
                            </div>
                            <div style="text-align:left;">
                            ...
                            <div style="text-align:left;">
                                ...
                                <select required name="competencia"  id="competencia" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" disabled>
                        ...
                        ?>
                                <h3>Solicitud</h3>
                                    ...
                                    ?>
                                        ...
                                        {!! Form::label('checkcedula2', 'Copia Cedula Solicitante',['disabled' => true]) !!}
                                    </div>
                                    <div style="text-align:left;">
                                    <?php
                                        $valor = false;
