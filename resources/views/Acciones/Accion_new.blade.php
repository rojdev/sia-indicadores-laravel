...
@section('contentheader_title')
    <div style="text-align: center">
        @if($tipo == 1)
            <h2><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px">Crear Solicitudes de Denuncias, Quejas, Reclamos</h2>
        @elseif($tipo == 2)
            <h2><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px">Crear Solicitudes de Asesorias, Sugerencias</h2>
        @endif
    </div>
@endsection

@section('main-content')
    <div class="container-fluid">  {{-- Removed w-75 and max-width --}}
        <div class="row">  {{-- Added a row to manage the layout --}}
            <div class="col-md-9">  {{-- Form will take 9/12 of the width --}}
                <div class="card">
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <?php
                            ...
                            echo "<script> var rolsJS = '". $rols_id. "'; var direccionJS = '". $direccion_id. "'; var tipoJS = '". $tipo. "'; </script>";
                      ?>

                        {!! Form::open(['route' => 'acciones.store', 'method' => 'POST', 'id' => 'form_acciones_id', 'enctype' => 'multipart/form-data'])!!}
                        {{ csrf_field() }}
                        ...
                        <div class="row">  {{-- Start of main row for two-column layout --}}
                            <div class="col-md-6">
                            <h3>Datos de la Accion</h3>{{-- First column --}}
                                <div class="form-group">
                                    {!! Form::label('direccion_label', 'DIRECCION', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                ...
                                <div class="form-group">
                                    {!! Form::label('coordinacion', 'COORDINACION', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('nombre', old('nombre'), ['placeholder' => 'Descripcion de la Accion de Gobierno', 'class' => 'form-control', 'id' => 'nombre_user', 'required' => true])!!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('fechainicial','Fecha Inicial', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                    {!! Form::date('fechainicial', old('fechainicial'), ['class' => 'form-control', 'id' => 'fechainicial', 'required' => true])!!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('fechafinal','Fecha Final', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                    {!! Form::date('fechafinal', old('fechafinal'), ['class' => 'form-control', 'id' => 'fechafinal', 'required' => true])!!}
                                </div>
                                <br>
                                <br>
                                <br>
                                <br>
                                {!! Form::submit('Acciones', ['class' => 'form-control btn btn-primary', 'title' => trans('message.solicitud_action.new_solicitud'), 'data-toggle' => 'tooltip', 'style' => 'background-color:'. $array_color['group_button_color']. ';'])!!}
                            ...
                            <h3>Datos de la Ubicación</h3>
                                <div class="form-group">
                                    {!! Form::label('estado_id','ESTADO', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                ...
                                <div class="form-group">
                                    {!! Form::label('municipio_id', 'MUNICIPIO', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                ...
                                <div class="form-group">
                                    {!! Form::label('parroquia_id', 'PARROQUIA', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                ...
                                <div class="form-group">
                                    {!! Form::label('comuna_id', 'COMUNA', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                ...
                                <div class="form-group">
                                    {!! Form::label('comunidad_id', 'COMUNIDAD', ['class' => 'control-label'])!!}<span class="required" style="color:red;">*</span>
                                 ...
                                 <div class="form-group">
                                    {!! Form::label('jefecomunidad_id', 'JEFE DE COMUNIDAD', ['class' => 'control-label'])!!}
                                    <p name="jefecomunidad_id" id="jefecomunidad_id" class="form-control" disabled>
                                ...
                                <div class="form-group">
                                    {!! Form::label('telefonoJEFE_label', 'TELEFONO DE JEFE DE COMUNIDAD', ['class' => 'control-label'])!!}<span
                                ...
                                <div class="form-group">
                                    {!! Form::label('nombreUBCH_label', 'NOMBRE DE UBCH', ['class' => 'control-label'])!!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('nombre_vocero','Nombre Vocero Concejo Comunal', ['class' => 'control-label'])!!}<span
                                        class="required" style="color:red;">*</span>
                                    {!! Form::text('vocero', old('Vocero'), ['placeholder' => 'Nombre Vocero Concejo Comunal', 'class' => 'form-control', 'id' => 'vocero', 'required' => true])!!}
                                </div>
                                <div class="form-group">
                                {!! Form::label('telefono_vocero','Telefono Vocero Consejo Comunal', ['class' => 'control-label']) !!}
                                {!! Form::text('telefono', old('telefono'), ['placeholder' => 'Telefono Vocero Consejo Comunal', 'class' => 'form-control', 'id' => 'telefono_user', 'required' => true]) !!}
                                </div>
                                <div class="form-group">
            ...
            <div class="col-md-3">  {{-- Sidebar will take 3/12 of the width --}}
