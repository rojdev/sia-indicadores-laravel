    ...
    <div class="card">
        <div class="card-body">
            <div class="col-lg-12 col-xs-12">
                ...
                @endif   
                {!! Form::open(array('route' => array('servicio.update',$servicio->id),
                ...
                <div class="col-lg-6 col-xs-6">                    
                    <div style="text-align:left;">
                        ...
                        {!! Form::text('nombre',$servicio->nombre,['class' => 'form-control','id' => 'name_rol', 'disabled' => false]) !!}
                    </div>
                    <div style="text-align:left;">
                        {!! Form::label('descripcion',trans('message.modulo_action.description'), ['class' => 'control-label']) !!}<span class="required" style="color:red;">*</span>
                        {!! Form::text('descripcion',$servicio->descripcion,['class' => 'form-control','id' => 'name_description']) !!}
                    </div>                            
                </div>        
                <hr>
