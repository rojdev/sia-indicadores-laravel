...
@endcomponent
    <h2 style="margin: -1.25rem auto 1.25rem auto; text-align: center"><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px" >Reporte Acciones de Gobierno 2024</h2>
<div class="container-fluid">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    {!! Form::select('direcciones', [NULL => 'Seleccionar'] + $direcciones->toArray(), NULL, ['class' => 'form-control', 'id' => 'direccion_id']) !!}
                </div>
                <div class="col-md-2">
    ...
    <a href="#" id="btn_excell"> <button class="btn btn-primary" style="padding:5px;" id="btn_imprimirexcel"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red; background-color: white;"></i> Excell</button> </a>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#btn_listado').click(function() {
            ...
            var url = "{{ route('imprimirdetallado') }}" + "?fecha_desde=" + fechaDesde + "&fecha_hasta=" + fechaHasta + "&comuna=" + comuna + "&comunidad=" + comunidad + "&direcciones=" + direccion;
        ...
        // Declarar la variable table en el ámbito global
        var table;
    ...
    $('#btn_filtrar').click(function() {
        ...
        if (!$.fn.DataTable.isDataTable('.solicitud_all')) {
            ...
            table = $('.solicitud_all').DataTable({
                ...
                autoWidth : false,
                ajax: {
                    url: "{{ route('reporte.getdataaccionesnew') }}",
                    data: function (d) {
                        d.fecha_desde = $('#fecha_desde').val();
                        d.fecha_hasta = $('#fecha_hasta').val();
                        d.comuna = $('#comuna_id').val();
                        d.comunidad = $('#comunidad_id').val();
                        d.direcciones = $('#direccion_id').val();
                    }
                },
                columns: [
                    {
            ...
            //Recarga la tabla si ya esta inicializada.
            table.ajax.reload();
        }
