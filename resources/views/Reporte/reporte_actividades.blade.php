...
@endcomponent
    <h2 style="margin: -1.25rem auto 1.25rem auto; text-align: center"><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px" >Reporte Actividades de Gobierno 2022-2023</h2>
<div class="container-fluid">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    {!! Form::select('direcciones', [NULL => 'Seleccionar'] + $direcciones->toArray(), NULL, ['class' => 'form-control', 'id' => 'direcciones']) !!}                </div>
                <div class="col-md-2">
    ...
    <a href="#" id="btn_excell"> <button id="btn_imprimirexcel" class="btn btn-primary" style="padding:5px;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red; background-color: white;"></i> Imprimir</button> </a>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var url = "{{ route('imprimiractividadesExcel') }}" + "?fecha_desde=" + fechaDesde + "&fecha_hasta=" + fechaHasta + "&comuna=" + comuna + "&comunidad=" + comunidad + "&direcciones=" + direccion;
        ...
        var table = $('.solicitud_all').DataTable({
            ...
            autoWidth : false,
            ajax: {
                url: "{{ route('reporte.getdataactividades') }}",
                data: function (d) {
