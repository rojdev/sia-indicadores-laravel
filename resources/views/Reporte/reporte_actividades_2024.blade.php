...
@endcomponent
    <h2 style="margin: -1.25rem auto 1.25rem auto; text-align: center"><img src="{{ url('/images/icons/logoSIA.png') }}" alt="logo" height="100px" >Reporte Actividades de Gobierno 2024</h2>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var table = $('.solicitud_all').DataTable({
            ...
            autoWidth : false,
            ajax: {
                url: "{{ route('reporte.getdataactividadesnew') }}",
                data: function (d) {
