...
<script type="text/javascript">
    ...
    $(function () {
        $('#btn_listado').click(function() {
            ...
            var url = "{{ route('imprimiraccionesgobiernototales') }}" + "?fecha_desde=" + fechaDesde + "&fecha_hasta=" + fechaHasta + "&comuna=" + comuna ;
        ...
        paging: false,
            ajax: {
                url: "{{ route('total.totalescomunidadxcomuna') }}",
                data: function (d) {
    ...
    render: function (data, type, row) {
        return data === 'ZTotales Generales' ? 'Totales Generales' : data;
                ...
                {data: 'politicas', name: 'politicas'},
                {data: 'insfraestructura', name: 'insfraestructura'},
                {data: 'catastro', name: 'catastro'},
